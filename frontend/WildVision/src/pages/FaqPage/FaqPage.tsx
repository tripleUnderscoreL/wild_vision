  ...
  <>
    ...
    <div className="faq">
        ...
        <section>
          ...
          <p>Каждый запрос на возврат рассматривается по отдельности нашими менеджера.... </p>
        </section>
        <section>
          <p>Где посмотреть отзывы? </p>
          <p>У нас есть несколько источников, где выкладываются отзывы покупателей. Нап.... </p>
        </section>
        <section>
          <p>Кто производитель?</p>
          <p>Мы сотрудничаем с несколькими иностранными производителями. В основном .... </p>
        </section>
        <section>
          <p>Какие документы нужны?  </p>
          <p>Для оформления заказа вам необходимо иметь при себе документ подтверждаю....    </p>
        </section>
      </div>
